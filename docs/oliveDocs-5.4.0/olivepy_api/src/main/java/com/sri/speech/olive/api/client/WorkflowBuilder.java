...
//    }
  ...
  public Olive.WorkflowDefinition buildSADandLIDWorkflow(){

    // hack
    Olive.JobDefinition.Builder workflowJob = Olive.JobDefinition.newBuilder();
    workflowJob.setDataProperties(Olive.DataHandlerProperty.newBuilder()
