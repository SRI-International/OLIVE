...
public class WorkflowUtils {
     ...
     */
    public static Map<String, JobResult>  extractWorkflowAnalysis(Olive.WorkflowAnalysisResult result){
        ...
        for (Olive.WorkflowJobResult job : result.getJobResultList()){
...
//            Map<String, TaskResult> taskMap = new HashMap<>();
            ...
            for(Olive.WorkflowDataResult dResult : job.getDataResultsList()){
                dataResults.add(new DataResult(dResult, job.getJobName()));
            }

            // Now process the tasks
//            List<TaskResult> tResults = new ArrayList<>();
            for(Olive.WorkflowTaskResult tResult : job.getTaskResultsList()){
            ...
            System.out.println("Number returned tasks: " + taskMap.size() );
    ...
    public static void extractWorkflowAnalysisByJob(Olive.WorkflowAnalysisResult result){
        // todo group by job?
