...
public class TaskResult {
    ...
    public TaskResult(Workflow.WorkflowTaskResult taskResult, String jobName, List<DataResult> dataResults ){
    ...
    public Olive.MessageType getMessageType(){return messageType;}
