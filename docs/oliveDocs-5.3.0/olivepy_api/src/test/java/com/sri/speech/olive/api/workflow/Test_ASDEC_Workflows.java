...
//                .addOption(ov)
    ...
    public void testCreatingASDECWorkflowDef_AED() throws Exception {
        ...
        /*Olive.AbstractWorkflowPluginTask.Builder sad_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("sed-rmsEnergy-v1.0.0").build())
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_NEWEST_VERSION))
                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("default"));*/
        ...
        Olive.JobDefinition.Builder analysisJob = Olive.JobDefinition.newBuilder()
                ...
                .addTasks(Olive.WorkflowTask.newBuilder()
                        ...
                        .addOptionMappings(Olive.OptionMap.newBuilder().setWorkflowKeywordName("SED").setPluginKeywordName("SED").build())
                        .setReturnResult(true))
                .addTasks(Olive.WorkflowTask.newBuilder()
                        .setTask("__env__")
        ...
        Olive.WorkflowOrderDefinition.Builder analysiOrder = Olive.WorkflowOrderDefinition.newBuilder()
                .setWorkflowType(Olive.WorkflowType.WORKFLOW_ANALYSIS_TYPE)
                .addJobDefinition(analysisJob)
                .setOrderName("Analysis Order");
        Olive.WorkflowOrderDefinition.Builder enrollmentOrder = Olive.WorkflowOrderDefinition.newBuilder()
...
//        result.getRep().getWorkflow().writeTo(fos);
    ...
    public void testCreatingASDECWorkflowDef_Speech_Analysis() throws Exception {
        ...
        // VTD
       /* Olive.AbstractWorkflowPluginTask.Builder vtd_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("vtd-dnn").build())
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_NEWEST_VERSION))
                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("vtd"));*/
...
//        Olive.GlobalScorerRequest.Builder power_task = Olive.GlobalScorerRequest.newBuilder().setPlugin("mex-powerSupplyHum-v1.0").setDomain("default-v1");
        ...
        /*Olive.AbstractWorkflowPluginTask.Builder vocal_effort = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("voi-voiceCharacterization").build())
                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("vocalEffort"));*/
        ...
        /*Olive.AbstractWorkflowPluginTask.Builder speakings_style_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("voiceCharacterization").build())
                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("speakingStyle"));*/
        ...
        /*Olive.AbstractWorkflowPluginTask.Builder speaker_count_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("mex-speakercount").build())
                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("default"));*/
        ...
        /*Olive.AbstractWorkflowPluginTask.Builder reverb_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("mex-multi").build())
        ...
        Olive.JobDefinition.Builder job = Olive.JobDefinition.newBuilder()
                ...
                .addTasks(Olive.WorkflowTask.newBuilder()
                        ...
                        .addOptionMappings(Olive.OptionMap.newBuilder().setWorkflowKeywordName("SAD").setPluginKeywordName("SAD").build())
                        .setReturnResult(true))
                .addTasks(Olive.WorkflowTask.newBuilder()
                        .setTask("__voi__")
                        .setTraitOutput(Olive.TraitType.GLOBAL_SCORER)
...
//        Olive.GlobalScorerRequest.Builder count_task = Olive.GlobalScorerRequest.newBuilder().setPlugin("mex-speakercount").setDomain("multi-v1");
        ...
        Olive.AbstractWorkflowPluginTask.Builder count_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("mex-speakercount").build());
//                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("multi"));
...
//        analysisResult.getRep().writeTo(fos);
    ...
    public void testCreatingASDECWorkflowDef_Background_Noise() throws Exception {
        ...
        /*Olive.AbstractWorkflowPluginTask.Builder count_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("nsd-sadInverter").build());*/
...
//                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("multi"));
        ...
        Olive.AbstractWorkflowPluginTask.Builder lid_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("mex-multi").build());
//                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("vocaleffort").build());
//                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_NEWEST_VERSION)
//                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("multi"));
...
//        fos = new FileOutputStream( FileSystems.getDefault().getPath("/tmp/sad_lid_sid_analysis_result.workflow").toFile());
    ...
    public void testCreatingASDECWorkflowDef_VocalEffor() throws Exception {
        ...
        Olive.AbstractWorkflowPluginTask.Builder lid_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("voi-voiceCharacterization").build())
                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("vocalEffort").build());
//                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_NEWEST_VERSION)
//                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("multi"));
...
//        fos = new FileOutputStream( FileSystems.getDefault().getPath("/tmp/sad_lid_sid_analysis_result.workflow").toFile());
    ...
    public void testCreatingASDECWorkflowDef_SED_AED() throws Exception {
        ...
        // This should be an invalid SAD request - NO domain with the name 'test'
        Olive.AbstractWorkflowPluginTask.Builder sad_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("sed").build());
//                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("tel-v1"));

        Olive.AbstractWorkflowPluginTask.Builder lid_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("aed-enrollable").build());
//                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("multi"));
...
//                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("tel-v1"));
        ...
        Olive.AbstractWorkflowPluginTask.Builder lid_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("mex-indoorOutdoor").build());
//                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("multi"));
...
//        fos = new FileOutputStream( FileSystems.getDefault().getPath("/tmp/sad_lid_sid_analysis_result.workflow").toFile());
    ...
    public void testCreatingASDECWorkflowDef_NSD() throws Exception {
        ...
        Olive.AbstractWorkflowPluginTask.Builder sad_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("sad-dnn").build())
                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_STARTS).setValue("multi"));
...
//                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("default"));
        ...
        Olive.AbstractWorkflowPluginTask.Builder lid_task = Olive.AbstractWorkflowPluginTask.newBuilder()
                .addPluginCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("ind-outd").build());
//                .addDomainCriteria(Olive.SelectionCriteria.newBuilder().setType(Olive.SelectionType.SELECTION_CONTAINS).setValue("multi"));
